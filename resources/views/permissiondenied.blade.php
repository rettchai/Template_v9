...
<body class="antialiased">
    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
        ...
        <g>
            ...
            <text class="text-center" opacity="0.6" x="50" y="257" fill="#000" font-family="Viga"
                font-size="23">Permission Denied
                <tspan x="15" y="292">You don't have permission</tspan>
                <tspan x="70" y="357" fill="#000" font-size="65">
                    <a class="text-purple-600" href="{{route('login')}}">Login</a></tspan>
                <tspan x="93" y="381.2" fill="#000" font-size="15">please login again.</tspan>
            </text>

            <text x="50" y="255" fill="#6BA184" font-family="Viga" font-size="23">
                Permission Denied
                <tspan x="15" y="290">You don't have permission</tspan>
                <tspan x="70" y="355" fill="#BF3E73" font-size="65">
                   <a class="text-purple-600" href="{{route('login')}}">Login</a>
                </tspan>
                <tspan x="93" y="380" fill="#6BA184" font-size="15">please login again.</tspan>
            </text>
        </g>
